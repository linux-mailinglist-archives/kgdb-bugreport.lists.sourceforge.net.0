...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id DFB5549E0CA
	for <lists+kgdb-bugreport@lfdr.de>; Thu, 27 Jan 2022 12:28:11 +0100 (CET)
Received: from [127.0.0.1] (helo=sfs-ml-2.v29.lw.sourceforge.com)
	by sfs-ml-2.v29.lw.sourceforge.com with esmtp (Exim 4.94.2)
	(envelope-from <kgdb-bugreport-bounces@lists.sourceforge.net>)
	id 1nD2wl-0007y3-Me
	for lists+kgdb-bugreport@lfdr.de; Thu, 27 Jan 2022 11:28:10 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-2.v29.lw.sourceforge.com with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.94.2)
 (envelope-from <christophe.leroy@csgroup.eu>) id 1nD2wi-0007xv-1w
 for kgdb-bugreport@lists.sourceforge.net; Thu, 27 Jan 2022 11:28:06 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=EuoAcwdro5/8HcduMJqG9w864tNel6knvYxF7+65CzM=; b=A0DAVGRjS5O7P5uoce30Ttqiyd
 y82JCtfu6wwdmKbY4VKTyjfzqJpxbuGN1aMINloHg1Bd357SJf0N3BWPDBhPAEWgbzTDbQjj9BuMO
 K00/jE/N2AZ37MMGjpFcwk0d6f+YjlKoJfYv+py4LnJguHFuU1VTvfSU1eLwyIfO/L8Q=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 bh=EuoAcwdro5/8HcduMJqG9w864tNel6knvYxF7+65CzM=; b=jM5tJVLmrMX1RVWyuwjfmg08kb
 yyh1MN45IkWD9DDatcFvFVELvEpgrcNgIv8GjzMZGSGXPFvnLM8edTUp7QCx161v7K6j0ncS+aX0T
 hyA9bMT4LJFTHyQfFhZjHEP2nY5Vu5jDSFCkqnyANp/AoA+7rVEiJk0Eg4nm6Ee3bWY4=;
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 27 Jan 2022 11:27:57.7808 (UTC)
...
X-Spam-Report: Spam detection software,
 ...
 trees. This also means that struct mod_tree_root is required even without
 MODULES_TREE_LOOKUP. Also remove module_addr_min and module_addr_max as there
 will be one min and one max for each tree. 
...
X-Headers-End: 1nD2wf-0006y6-Vo
Subject: [Kgdb-bugreport] [PATCH v2 1/5] modules: Always have struct
 mod_tree_root
