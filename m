...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 474B14C7090
	for <lists+kgdb-bugreport@lfdr.de>; Mon, 28 Feb 2022 16:29:32 +0100 (CET)
Received: from [127.0.0.1] (helo=sfs-ml-1.v29.lw.sourceforge.com)
	by sfs-ml-1.v29.lw.sourceforge.com with esmtp (Exim 4.94.2)
	(envelope-from <kgdb-bugreport-bounces@lists.sourceforge.net>)
	id 1nOhxs-0008CY-9b
	for lists+kgdb-bugreport@lfdr.de; Mon, 28 Feb 2022 15:29:30 +0000
...
X-Mailman-Approved-At: Mon, 28 Feb 2022 15:29:29 +0000
Subject: [Kgdb-bugreport] [PATCH 0/6] Remove usage of list iterator past the
 loop body
