...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 3C0476CC19E
	for <lists+kgdb-bugreport@lfdr.de>; Tue, 28 Mar 2023 16:01:24 +0200 (CEST)
Received: from [127.0.0.1] (helo=sfs-ml-3.v29.lw.sourceforge.com)
	by sfs-ml-3.v29.lw.sourceforge.com with esmtp (Exim 4.95)
	(envelope-from <kgdb-bugreport-bounces@lists.sourceforge.net>)
	id 1ph9t5-0004z2-Mc
	for lists+kgdb-bugreport@lfdr.de;
	Tue, 28 Mar 2023 14:01:22 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-3.v29.lw.sourceforge.com with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.95)
 (envelope-from <john.ogness@linutronix.de>) id 1ph9t4-0004yv-4l
 for kgdb-bugreport@lists.sourceforge.net;
 Tue, 28 Mar 2023 14:01:21 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=OPRp4Ax1RiJSvFoiX1wWlEGoPCAJbm9ARjbhwmyJTlg=; b=JGCBVvYGJoBSvauPA3Z9yTKH7n
 jr1yYm66gS4u5GA5klheVLvr99eWP6ptJiApiUXHEoHWADIUeZsxBsYlFYcufyrRN6kXo6EpS64x/
 18/TMDSQREyqY2V5LdguW8PAjq7vybDNtdMlsk/Ye4BXgDB0L3C20pn3hYLktvYqJ5wk=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 bh=OPRp4Ax1RiJSvFoiX1wWlEGoPCAJbm9ARjbhwmyJTlg=; b=VPsMtXQ66ltKJNrolkc1w5UBdB
 L8sRi7KIs38i4Z1r7BPfyvk2T6rZGo0x2IfAD7mrFPL85DJh2xORIw4hAC2sMHiO0XAmvFSgWRE5U
 hjjCx67MKPiGgVYMph9UDt2zWMxxpult6pYVoopYPAEqd7WkwEYv9Mr8oCV9XbeHCpj8=;
Received: from galois.linutronix.de ([193.142.43.55])
 by sfi-mx-1.v28.lw.sourceforge.com with esmtps
 (TLS1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.95)
 id 1ph9sx-0078RK-6x for kgdb-bugreport@lists.sourceforge.net;
 Tue, 28 Mar 2023 14:01:21 +0000
...
X-Spam-Report: Spam detection software,
 ...
 driver to perform as a nbcon console. Remove the implementation for the legacy
 console callback (write) and add implementations for the nbco [...] 
 ...
 author's domain
X-Headers-End: 1ph9sx-0078RK-6x
Subject: Re: [Kgdb-bugreport] [PATCH printk v1 00/18] POC: serial: 8250:
 implement nbcon console
