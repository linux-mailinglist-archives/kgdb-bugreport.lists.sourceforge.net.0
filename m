...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id C80806A8A19
	for <lists+kgdb-bugreport@lfdr.de>; Thu,  2 Mar 2023 21:19:49 +0100 (CET)
Received: from [127.0.0.1] (helo=sfs-ml-4.v29.lw.sourceforge.com)
	by sfs-ml-4.v29.lw.sourceforge.com with esmtp (Exim 4.95)
	(envelope-from <kgdb-bugreport-bounces@lists.sourceforge.net>)
	id 1pXpP2-0007tV-Gz
	for lists+kgdb-bugreport@lfdr.de;
	Thu, 02 Mar 2023 20:19:48 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-4.v29.lw.sourceforge.com with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.95)
 (envelope-from <john.ogness@linutronix.de>) id 1pXpOz-0007tO-UW
 for kgdb-bugreport@lists.sourceforge.net;
 Thu, 02 Mar 2023 20:19:46 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=DoYVoXVZrCYkg08eCZi+GFBjouXoTRm7NbD5Lab3y1I=; b=cu3V/ihLVP4FvrzVtYo2g4NP98
 XdbVAdToJdeVZ0ng/B/P/v9Nfl2kyBeKytbSNWCR/lJtKa1/WvmLMNfmeoDxbT05dBR3F4Yd3dWzw
 tYCpu8+z5UyyRL0+XS4T92dysSLxFjbBPcEZvKsQ5gObao4EaDHLk9dhH8VMTfmPsyZ0=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 bh=DoYVoXVZrCYkg08eCZi+GFBjouXoTRm7NbD5Lab3y1I=; b=XNxlWN9CbfTTSLn5lz8krEoui3
 ZWjKOEdBOaRp7ElQRm2G62vMpthD2L9oPSLkLZnJrWBIb5z3xpYt8M83LQnQ4aIdbNM8Hzi+HQ5Qj
 AvPVtSSZSbAS5hR8RWsuoX17vEMucLnuxC8qqsJvseLhsmTxcllKlKFjWbpGlY/ft54U=;
Received: from galois.linutronix.de ([193.142.43.55])
 by sfi-mx-2.v28.lw.sourceforge.com with esmtps
 (TLS1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.95)
 id 1pXpOw-0001v8-Ea for kgdb-bugreport@lists.sourceforge.net;
 Thu, 02 Mar 2023 20:19:45 +0000
...
X-Spam-Report: Spam detection software,
 ...
 Content preview: Implement the necessary callbacks to allow the 8250 console
 driver to perform as a non-BKL console. Remove the implementation for the
 legacy console callback (write) and add implementations for the no [...] 
 ...
 valid
X-Headers-End: 1pXpOw-0001v8-Ea
Subject: [Kgdb-bugreport] [PATCH printk v1 00/18] serial: 8250: implement
 non-BKL console
