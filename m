...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 2AEC24A7F95
	for <lists+kgdb-bugreport@lfdr.de>; Thu,  3 Feb 2022 08:05:30 +0100 (CET)
Received: from [127.0.0.1] (helo=sfs-ml-1.v29.lw.sourceforge.com)
	by sfs-ml-1.v29.lw.sourceforge.com with esmtp (Exim 4.94.2)
	(envelope-from <kgdb-bugreport-bounces@lists.sourceforge.net>)
	id 1nFWBO-0007ln-5J
	for lists+kgdb-bugreport@lfdr.de; Thu, 03 Feb 2022 07:05:28 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-1.v29.lw.sourceforge.com with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.94.2)
 (envelope-from <christophe.leroy@csgroup.eu>) id 1nFWBM-0007lh-6w
 for kgdb-bugreport@lists.sourceforge.net; Thu, 03 Feb 2022 07:05:26 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=eMhnRh6gbka+zQmbVEuSnoeIUGa17AJwtCOeF0V1CyY=; b=Cw9efJZiWfWr8LlJbmLwkKZaY7
 ZYE1ZsC/bZ/vf84fM6RN/u3/+hmWKzUULakPKZmxH38/z96wpkMhWMt+2jbaceZQxlQwImUFCSGQR
 xyMfWWFDPdqOJ71Z/nnrY9/NHXFe3bUcZoLxlCYkF+g7qrN1pQMXOqx23DFmkPrXtuLY=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 bh=eMhnRh6gbka+zQmbVEuSnoeIUGa17AJwtCOeF0V1CyY=; b=FQ5eW8N4+ooPdP+txASVLDkyCE
 hc/kdD8uBQrWiOB1Z75JrMhyGjsi1AOswsknnfxyBEwaIUbNJ1V8r/54xjTDazjQGxaKXOgWk8SYo
 kjkBEjTXn/23mYD8x7TpxAQiAjYff6NDqYciVYt0IkBmWm0gZitB5hB88i4AOpGyErXE=;
Received: from mail-eopbgr120052.outbound.protection.outlook.com
 ([40.107.12.52] helo=FRA01-PR2-obe.outbound.protection.outlook.com)
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 03 Feb 2022 07:05:13.6122 (UTC)
...
X-Spam-Report: Spam detection software, running on the system "util-spamd-1.v13.lw.sourceforge.com",
 ...
 Content preview:  Le 03/02/2022 à 01:01, Luis Chamberlain a écrit : > On
   Sat, Jan 29, 2022 at 05:02:09PM +0000, Christophe Leroy wrote: >> diff --git
    a/kernel/module.c b/kernel/module.c >> index 11f51e17fb9f..f37581 [...] 
 ...
 -0.0 RCVD_IN_MSPIKE_H2      RBL: Average reputation (+2)
                             [40.107.12.52 listed in wl.mailspike.net]
 -0.0 RCVD_IN_DNSWL_NONE     RBL: Sender listed at https://www.dnswl.org/,
                              no trust
                             [40.107.12.52 listed in list.dnswl.org]
 -0.0 SPF_HELO_PASS          SPF: HELO matches SPF record
 -0.0 SPF_PASS               SPF: sender matches SPF record
 -2.0 NICE_REPLY_A           Looks like a legit reply (A)
X-Headers-End: 1nFWBG-0000nb-Gj
