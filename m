...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id F260E4C00EB
	for <lists+kgdb-bugreport@lfdr.de>; Tue, 22 Feb 2022 19:06:12 +0100 (CET)
Received: from [127.0.0.1] (helo=sfs-ml-1.v29.lw.sourceforge.com)
	by sfs-ml-1.v29.lw.sourceforge.com with esmtp (Exim 4.94.2)
	(envelope-from <kgdb-bugreport-bounces@lists.sourceforge.net>)
	id 1nMZYD-0004zs-16
	for lists+kgdb-bugreport@lfdr.de; Tue, 22 Feb 2022 18:06:11 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-1.v29.lw.sourceforge.com with esmtps (TLS1.2) tls
 TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 (Exim 4.94.2)
 (envelope-from <christophe.leroy@csgroup.eu>) id 1nMZYB-0004zl-Ek
 for kgdb-bugreport@lists.sourceforge.net; Tue, 22 Feb 2022 18:06:10 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=fGAZ6PQQc7PnvKXWX474PrSUSO+kxkRBcSdQuU4DNFU=; b=GHP/up4hHHJDDjyjpDS5NhU/lD
 kSVbMgNTvP3fqWQ3KXk+UloXgJv1a0v7yyfWAnyw2aqEhpIknesB/XB4LVjVnj1h2WpiJ/DCBPrTh
 6NDDIAfAWFBpLO+jvJUE8QYGDYJwSkFgGVqVP2iO3hikNBS+6Q+D7D/c6W0zs9mEK56Y=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 bh=fGAZ6PQQc7PnvKXWX474PrSUSO+kxkRBcSdQuU4DNFU=; b=mQ8w2EQcn2JuuSa2FMiyLEkWh6
 aT/VBnk+rGTp2f0gRahs5RfWg0QYNy20oey53PS4++TcmX6vBuoEHCevsksCE5anrYuBavkc/5V4p
 moRLwUMCVZI1ndLd0C+Wp4F2ELL6m0kHGfJaZoqu7dPqx6Q94ZLFCPkUAnRDFmL0Rr1c=;
Received: from mail-eopbgr90071.outbound.protection.outlook.com ([40.107.9.71]
 helo=FRA01-MR2-obe.outbound.protection.outlook.com)
 by sfi-mx-1.v28.lw.sourceforge.com with esmtps
 (TLS1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.94.2)
 id 1nMZY4-00BZUN-8k
 for kgdb-bugreport@lists.sourceforge.net; Tue, 22 Feb 2022 18:06:09 +0000
...
X-MS-Exchange-CrossTenant-originalarrivaltime: 22 Feb 2022 18:05:56.1512 (UTC)
...
X-Spam-Report: Spam detection software, running on the system "util-spamd-2.v13.lw.sourceforge.com",
 ...
 Content preview:  + Daniel and Jason. The full series is available at https://patchwork.kernel.org/project/linux-modules/list/?series=616741&state=*
    Le 22/02/2022 à 15:13, Aaron Tomlin a écrit : > No functional change.
   > > This patch migrates kdb_modules list to core kdb code > since the list
    of added/or loaded modules is no longer > private. > [...] 
 ...
 -0.0 RCVD_IN_DNSWL_NONE     RBL: Sender listed at https://www.dnswl.org/,
                              no trust
                             [40.107.9.71 listed in list.dnswl.org]
 -0.0 RCVD_IN_MSPIKE_H2      RBL: Average reputation (+2)
                             [40.107.9.71 listed in wl.mailspike.net]
 -0.0 SPF_HELO_PASS          SPF: HELO matches SPF record
 -0.0 SPF_PASS               SPF: sender matches SPF record
 -0.0 T_SCC_BODY_TEXT_LINE   No description available.
 -0.0 NICE_REPLY_A           Looks like a legit reply (A)
X-Headers-End: 1nMZY4-00BZUN-8k
Subject: Re: [Kgdb-bugreport] [PATCH v8 12/13] module: Move kdb_modules list
 out of core code
...
Cc: "pmladek@suse.com" <pmladek@suse.com>,
 ...
 "void@manifault.com" <void@manifault.com>, "jeyu@kernel.org" <jeyu@kernel.org>,
 "joe@perches.com" <joe@perches.com>, "cl@linux.com" <cl@linux.com>,
...
ZmRlZiBDT05GSUdfTE9DS0RFUApfX19fX19fX19fX19fX19fX19fX19fX19fX19fX19fX19fX19f
