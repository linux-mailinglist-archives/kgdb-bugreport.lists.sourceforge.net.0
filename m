...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 5D4DC1EE21E
	for <lists+kgdb-bugreport@lfdr.de>; Thu,  4 Jun 2020 12:10:30 +0200 (CEST)
Received: from [127.0.0.1] (helo=sfs-ml-4.v29.lw.sourceforge.com)
	by sfs-ml-4.v29.lw.sourceforge.com with esmtp (Exim 4.90_1)
	(envelope-from <kgdb-bugreport-bounces@lists.sourceforge.net>)
	id 1jgmpR-0005Nf-58
	for lists+kgdb-bugreport@lfdr.de; Thu, 04 Jun 2020 10:10:29 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-4.v29.lw.sourceforge.com with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.90_1)
 (envelope-from <sumit.garg@linaro.org>) id 1jgmpQ-0005NZ-PE
 for kgdb-bugreport@lists.sourceforge.net; Thu, 04 Jun 2020 10:10:28 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=cSMsedy5D9EjXfOQ+gVM5gigk9Y2fdZphIu9yrJTcR0=; b=RwZKXNcOKUuXOxfdqu1UP1Z31F
 bJtlHxbPqsYMQHvH/OVWJItde479YuazKln33Pw/KjCfC9yG+DjvzEvzAIrKGCqeD+hjzi/u+/Cpm
 9hxSb094g5ZdR3597cA20jBgQ3M+Hcf/GL0rVzige6zg00OnYtrHJsoh2iomWa+j6MQQ=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 bh=cSMsedy5D9EjXfOQ+gVM5gigk9Y2fdZphIu9yrJTcR0=; b=jeh2Gi5VSAnHVjGFq5so/CBnMp
 92yo8NXO71Z2CX2s5ALrSBY7wjuesJJTvAxhbhHurr0K8A2/yRfgVtbSheNGBFVQIhjRL4zVQVLaO
 9McvmE4/rmYBHaxFXCYvPH4Xa/26ngAgkDZ3/I7zRnSLSsBJKwUTq+UvL0XI1A6AHNlw=;
Received: from mail-oi1-f195.google.com ([209.85.167.195])
 by sfi-mx-3.v28.lw.sourceforge.com with esmtps
 (TLSv1.2:ECDHE-RSA-AES128-GCM-SHA256:128) (Exim 4.92.2)
 id 1jgmpO-008WEl-8O
 for kgdb-bugreport@lists.sourceforge.net; Thu, 04 Jun 2020 10:10:28 +0000
Received: by mail-oi1-f195.google.com with SMTP id p70so4552664oic.12
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 ...
 :references;
 bh=cSMsedy5D9EjXfOQ+gVM5gigk9Y2fdZphIu9yrJTcR0=;
 b=
X-Gm-Message-State: AOAM533B7aU6T3y5AIc1sZo09zlPjusmY/49/gZ4zkGpab53MjoLiaFM
 dNQ9olnnJXZl47Hj42ozrZI96Bzbic0=
...
X-Received: by 2002:a17:90a:ad03:: with SMTP id
 r3mr5188507pjq.104.1591264926786; 
...
X-Headers-End: 1jgmpO-008WEl-8O
Subject: [Kgdb-bugreport] [PATCH v6 4/4] kdb: Switch to use safer dbg_io_ops
 over console APIs
