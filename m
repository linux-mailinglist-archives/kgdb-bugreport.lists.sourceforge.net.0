...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id E474E497CA4
...
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 ...
 (envelope-from <christophe.leroy@csgroup.eu>) id 1nBvny-0001ut-D7
 for kgdb-bugreport@lists.sourceforge.net; Mon, 24 Jan 2022 09:38:29 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=4vYHN3GX5aVxixYLF0RC1M6EWpoRCEfxGB8h8Addwkk=; b=Sf/uor9Dd1DmTEKbAiKhb3s081
 nwxqYogm/B44jlUOksWOZuCxkCM5QwwOJUAaGjJHdNNUxp0KCt9wxDzW+AQ1RDUOmr6KJkzdz79An
 c2GJxiBLObf5rZR/e3VCgxrZ2BEr3c4Ds+gRKqeDSs1KsA0txOftb45aA6e6uKMxNnI0=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 bh=4vYHN3GX5aVxixYLF0RC1M6EWpoRCEfxGB8h8Addwkk=; b=dymHYCA1bPAgIvXqHl6oCgRwY6
 ge2TaSiDhGGyYgiwKGLHe4aRhBa4EaGkd9g1K5zLtDF6pWIJsV5dzwQyw00UgT1G6BaYZyInt+nlZ
 6iPShFkqfe0a7yppZFNvZgS4smPAoSREgivsT0ESC1qPvIn38vx4xXTT5LLgbMgiElyc=;
Received: from mail-eopbgr90084.outbound.protection.outlook.com ([40.107.9.84]
...
X-Spam-Report: Spam detection software,
 ...
 trees. So modify functions to give the tree as a parameter. Signed-off-by:
 Christophe Leroy <christophe.leroy@csgroup.eu> --- kernel/module.c | 38
 +++++++++++++++++++
 ...
 [40.107.9.84 listed in wl.mailspike.net]
 -0.0 RCVD_IN_DNSWL_NONE     RBL: Sender listed at https://www.dnswl.org/,
 no trust [40.107.9.84 listed in list.dnswl.org]
X-Headers-End: 1nBvns-00ADCK-WA
X-Mailman-Approved-At: Mon, 24 Jan 2022 10:02:43 +0000
Subject: [Kgdb-bugreport] [PATCH 4/7] modules: Prepare for handling several
 RB trees
